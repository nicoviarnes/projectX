$(document).ready(function(){
	// $('#messageModal').hide('hide');
  //initialize the firebase app
  /*var config = {
    apiKey: "AIzaSyAohhWTTW5_sLXkBeN98hnQjAIveM5NS1g",
    authDomain: "mobileapp-50131.firebaseapp.com",
    databaseURL: "https://mobileapp-50131.firebaseio.com",
    projectId: "mobileapp-50131",
    storageBucket: "mobileapp-50131.appspot.com",
    messagingSenderId: "624859343111"
  };
  firebase.initializeApp(config);
  */

  var config = {
    apiKey: "AIzaSyDeKNgUXgPf5HkDMxdZxdLkb-IgctmICeg",
    authDomain: "mobile-app-af43f.firebaseapp.com",
    databaseURL: "https://mobile-app-af43f.firebaseio.com",
    projectId: "mobile-app-af43f",
    storageBucket: "mobile-app-af43f.appspot.com",
    messagingSenderId: "842996218037"
  };
  firebase.initializeApp(config);
  ...
  var contactsRef = dbRef.ref('mobile-app-af43f');
